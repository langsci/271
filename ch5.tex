...
\pex
	...
	\begin{minipage}[t]{0.6\textwidth}
		``According to his testimony, in the early 60s, before he began his political career in the USA, \dots\\
	\begingl
		\gla \textipa{S}aha sanderz kama xodaʃim be-israel ve-hitnadev be-\textbf{kibu\texttslig}//
...
Second, a simple noun might not even have any corresponding action nominal if there is no underlying verb. The noun \emph{kibu\textipa{S}} `occupation' is not derived from an underlying verb in {\tpie}. 
\pex
	\a \begingl
		\gla daj la-kibu\textipa{S}//
		\glb enough to.the-occupation//
		\glft `Down with the occupation!'//
	\endgl	
	\a \ljudge{*} \emph{kibe\textipa{S}}
\xe
