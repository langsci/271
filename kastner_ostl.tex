...
\usepackage{expex} %Linguistics examples
	\lingset{aboveexskip=0.5ex,belowexskip=0.1ex,aboveglftskip=0.1ex,interpartskip=0.1em,labelwidth=!6pt,belowpreambleskip=0.1ex} %, *=*?}
	\usepackage{epltxfn}
...
% end of added stuff from Jen's main
    ...
    \newchapter{ch1}{The trivalency of Voice}
...
\part{Hebrew}
    ...
    \newchapter{ch5}{Passives and nominalizations}

\part{Crosslinguistic consequences}

    \newchapter{ch6}{Syntactic vs semantic transitivity}

    \newchapter{ch7}{The features of Voice}

    \newchapter{ch8}{Conclusion}
