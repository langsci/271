...
% end of added stuff from Jen's main
    ...
    \newchapter{chapters/01}{The trivalency of Voice}

\part{Hebrew}

    \newchapter{chapters/02}{Underspecified Voice}

    \newchapter{chapters/03}{\vz}

    \newchapter{chapters/04}{\vd}

    \newchapter{chapters/05}{Passives and nominalization}

\part{Crosslinguistic consequences}

    \newchapter{chapters/06}{Syntactic vs semantic transitivity}

%\addtocontents{toc}{\protect\setcounter{tocdepth}{0}}
    \newchapter{chapters/07}{The features of Voice}

    \newchapter{chapters/08}{Conclusion}
