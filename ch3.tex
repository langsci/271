...
\ex\label{ex:vz:is-figrefl}
	 ...
	 \glb he.NOM strolled in to room.the.ACC//
...
\pex\label{ex:vz:denote-va}
	...
	\a \denote{Voice} \lra~$\lambda$e$\lambda$x.Cause(x,e) or $\lambda$e$\lambda$x.Agent(x,e)
\xe
...
\pex
	...
	\glb the-bracelet dismantled.\gsc{INTNS.MID} {} from-itself {} {} in-skill {} {} by the-jeweler//
...
\scalebox{0.9}{
    ...
    \begin{tikzpicture}[overlay]
   	\draw[thick,->] (Obj) .. controls +(south:8) and +(south west:8) .. (SpecTP);
    \end{tikzpicture}
}
\xe
