...
\pex
	\a Adjective (stative): {[}\root{Root} a]
	\a Adjectival passive (resultative): {[}[a [Voice [\root{Root} v]]]
\xe
...
\pex \label{ex:pres-act}
 ...
 \begingl
     ...
     \glb tomorrow I will.be.\gsc{SMPL} eat.\gsc{SMPL.PRES} {} record.\gsc{SMPL.CAUS}//
...
\pex \label{ex:pres-ambig}
    ...
    \a \begingl
        ...
        \glb the-concert will.be.\gsc{SMPL} record.\gsc{CAUS.PASS}.Pres//
...
\pex \label{ex:pres-ambig2}
    ...
    \a \begingl
        ...
        \glb the-pot will.be.\gsc{SMPL} cover.\gsc{INTNS.PASS}.Pres//
...
\pex \label{ex:idiom}
    \a 
        ...
        \glb this will.be.\gsc{SMPL} understand.\gsc{CAUS}.\gsc{PASS}.Pres from-to.him//
...
\pex
    \a
        ...
        \glb this was.\gsc{SMPL} sucked.\gsc{SMPL} from-the-finger//
    ...
    \a
        ...
        \glb this sucked.\gsc{MID} from-the-finger//
...
\pex
	\a \begingl
		...
		\glb the-fog soon will.cover.\gsc{INTNS} \gsc{ACC} all the-street//
	...
	\a \ljudge{??}
		...
		\glb the-fog the-heavy will.be.\gsc{SMPL} cover.\gsc{INTNS}.Pres \gsc{ACC} all the-street//
...
\pex\label{ex:adjpass-heb1-tree} Adjectival passive in \emph{XaYuZ} (from {\tkal}):
    \a \begingl
        ...
        \glb the-book will.be.\gsc{SMPL} written in-pen blue//
...
\pex\label{ex:adjpass-heb2-tree} Adjectival passive in {\mpua} (from {\tpie}):
    \a \begingl
        ...
        \glb Danny will.be.\gsc{SMPL} combed.\gsc{INTNS.PASS}.Pres//
...
\ex\label{ex:sportait} \ljudge{*}
	\begingl
		...
		\glb Nadia Com\u{a}neci was.\gsc{SMPL}-\gsc{F} athlete.\gsc{F} {} prepared.\gsc{CAUS.PASS}-\gsc{F} carefully he did.\gsc{SMPL} job good but absorbed.\gsc{SMPL} much criticism//
...
\ex ``For whatever reason, after years of complete openness with Google, and full access to all of the data and information that I produce, it looks like the only thing they know about [me] is that I'm a man. Enough already! I'm tired of ads for shaving, cars, insurance and cologne! \dots ''\\
	\begingl
		...
		\glb how I can.\gsc{PTCP.SMPL} to.cause to-Google to.give to-me ad-\gsc{F.PL} \gsc{COMP}-really targeted.\gsc{INTNS.PASS.Pres}-\gsc{F.PL} to-me//
...
\pex
	...
	\begingl
		...
		\glb state-of Israel will.be.\gsc{SMPL} open to-immigration Jewish and-to-gathering.\gsc{INTNS}.of diasporas//
		\glft `The State of Israel will be open for Jewish immigration and for the Ingathering of the Exiles.'\trailingcitation{(Israeli Declaration of Independence)}//
	\endgl
	...
	\begingl
		...
		\glb stayed.\gsc{SMPL} Sanders a.few months in-Israel and-volunteered.\gsc{INTNS.MID} in-kibbutz//
...
\xe
In all of these cases except for \emph{izker} the \citeauthor{arad03}-style generalization holds. Whether these \emph{a}-nouns and \emph{i}-verbs have different structure than in the original \emph{m}-nouns and regular verbs discussed by \cite{arad03} is a potentially potentially interesting question. See also \cite{ouhalla16} for a different line of argumentation and \cite{brice16} for experimental evidence supporting root embedding.}
