...
The generalization for {\tpie}, then, is that verbs are weakly agentive and sometimes provide a more ``intensive'' or agentive version of an existing verb in {\tkal}. This is, admittedly, a very fine semantic line to tread. In what follows I review what I think are some similar phenomena across languages and empirical domains, before turning to the formal analysis.
