...
In~(\ref{ex:voice-intro-tr2}) we see the core \isi{transitive} verb \emph{taraf}, which requires an internal argument. The accusative\is{\isi{case}}/DOM marker \emph{et} must also appear, indicating that this is a \isi{transitive} construction.
 \begin{exe}
