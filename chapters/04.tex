...
With \emph{heet} `slowed down' I judge inchoatives unacceptable and causatives slight\-ly better though still degraded. These judgments are meant to highlight the variance, not to be taken as categorical for all alternations or all speakers.
 \begin{exe}
 \ex  
 \begin{xlist} 
 	\ex[] {  Adjective:\\  
