...
Part~\ref{part:2} provides a detailed comparison of the Trivalent theory with the ``\isi{Layering}'' theory in Chapter~\ref{chap:aas}. Chapter~\ref{chap:i} then summarizes with general considerations for the valence of Voice.