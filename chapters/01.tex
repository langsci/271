...
In other languages a ``\isi{causative} alternation'' can be observed, where the \isi{causative} variant is marked\is{\isi{markedness}}. The \ili{Japanese} example in~(\ref{ex:1n2}) exemplifies (transcription and glosses as in~\citealt[3]{oseki17nyu}).
 \begin{exe}
