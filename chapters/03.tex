...
This last set of VIs might seem overly complicated, but it is necessary in order to maintain a uniform VI for affixes across templates; see Chapter~\ref{vz:va:vzva}. This is one of a number of choice points in the phonological analysis which I will not defend here, since my focus is not on the morphophonology per se.

A simplified version of the phonological derivations:
\pex
