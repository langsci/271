...
Out of 415 verbs in {\tnif} classified by \cite{ahdoutkastner19nels}, 275 have only passive readings, 196 have only anticasuative or inchoative readings, and 88 are ambiguous (leading to totals above 415). I will return to the quantitative summary in Section~\ref{vz:tnif:sum}. All of the tests are consistent with the claim that the verbs classified as anticausative and inchoative have no Agent, hence are unaccusative, and that the verbs classified as passive verbs have an implicit or explicit Agent. The diagnostics were introduced in Chapter~\ref{voice:tkal:nact}.
