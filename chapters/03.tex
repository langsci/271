...
\pex 
	...
	\a
		\begingl
		\gla ha-xevel nimtax be-zehirut//
		\glb the-rope stretched.\gsc{MID} in-caution//
		\glft `The rope was stretched cautiously.'//
		\endgl
\xe
...
\pex
	\a \begingl
	\gla ha-kise niʃbar / neelam me-a{\ts}mo//
      \glb the-chair broke.\gsc{MID} {} disappeared.\gsc{MID} from-itself//
...
Passives are irrelevant but do pass the diagnostics.
...
74 verbs out of 415 in {\tnif} have figure reflexive readings.
...
Based on the diagnostics discussed above, \cite{ahdoutkastner19nels}
found that 196 of the 415 verbs in {\tnif} are anticausative, or ambiguous between anticausative---as discussed in this section---and figure reflexive. They were able to classify 415 verbs with a high degree of certainty (out of 462 in total), with the breakdown in~(\nextx).\footnote{While these findings are attributed to both authors of that work \citep{ahdoutkastner19nels}, they are entirely the result of careful work by Odelia Ahdout as part of \citep{ahdout19phd}.}
...
counterexamples:
neenax, neenak (emission)
nizak, nexpaz (subordinating)
nexgar (reflexive?)
