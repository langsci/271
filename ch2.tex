...
First, let me define underspecified Voice in (\nextx). All definitions of Voice heads in this and the following chapters take the same form: (a) syntactic definition, (b) semantic denotation, and (c) informal spell-out. I give these here and expand upon them in turn.
\pex \textbf{Voice}
...
%		\end{cases}$
 ...
 in terms of a Hebrew template, a crude placeholder for the morphophonological details \citep{kastner18nllt}.
...
Underspecifid Voice and {\tkal}. Nominalizations later.	
...
Also Doron doesn't use any special heads.
